...
<html lang="es">
    <head>
        ...
        <!-- Vendors Min CSS -->
        <link rel="stylesheet" href="..\..\public\assets\css\vendors.min.css">
        <!-- Style CSS -->
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportContent">
                                ...
                                <div class="dropdown-body">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-account.png" alt="image">
                                            <span class="d-block mb-0">Account</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-google.png" alt="image">
                                            <span class="d-block mb-0">Search</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-map.png" alt="image">
                                            <span class="d-block mb-0">Maps</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-youtube.png" alt="image">
                                            <span class="d-block mb-0">YouTube</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-playstore.png" alt="image">
                                            <span class="d-block mb-0">Play</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-gmail.png" alt="image">
                                            <span class="d-block mb-0">Gmail</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-drive.png" alt="image">
                                            <span class="d-block mb-0">Drive</span>
                                        </a>

                                        <a href="#" class="dropdown-item">
                                            <img src="..\..\public\assets\img\icon-calendar.png" alt="image">
                    ...
                    <ul class="navbar-nav right-nav align-items-center">
                        ...
                        <li class="nav-item dropdown language-switch-nav-item">
                            <a href="#" class="nav-link dropdown-toggle" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <img src="..\..\public\assets\img\us-flag.jpg" alt="image">
                            ...
                            <div class="dropdown-menu">
                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    ...
                                    <img src="..\..\public\assets\img\germany-flag.jpg" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>French</span>

                                    <img src="..\..\public\assets\img\france-flag.jpg" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>Spanish</span>

                                    <img src="..\..\public\assets\img\spain-flag.jpg" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>Russian</span>

                                    <img src="..\..\public\assets\img\russia-flag.jpg" alt="flag">
                                </a>

                                <a href="#" class="dropdown-item d-flex justify-content-between align-items-center">
                                    <span>Italian</span>

                                    <img src="..\..\public\assets\img\italy-flag.jpg" alt="flag">
                                </a>
                            </div>
                        </li>
                        ...
                        <li class="nav-item message-box dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="dropdown-body">
                                    ...
                                    <a href="#" class="dropdown-item d-flex align-items-center">
                                        <div class="figure">
                                            <img src="..\..\public\assets\img\user2.jpg" class="rounded-circle" alt="image">
                                        </div>
                                    ...
                                    <a href="#" class="dropdown-item d-flex align-items-center">
                                        <div class="figure">
                                            <img src="..\..\public\assets\img\user3.jpg" class="rounded-circle" alt="image">
                                        </div>
                                    ...
                                    <a href="#" class="dropdown-item d-flex align-items-center">
                                        <div class="figure">
                                            <img src="..\..\public\assets\img\user4.jpg" class="rounded-circle" alt="image">
                                        </div>
        ...
        <!-- ApexCharts JS -->
        <script src="..\..\public\assets\js\apexcharts\apexcharts.min.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apexcharts-stock-prices.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apexcharts-irregular-data-series.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-line-chart.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-pie-donut-chart.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-area-charts.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-column-chart.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-bar-charts.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-mixed-charts.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-radialbar-charts.js"></script>
        <script src="..\..\public\assets\js\apexcharts\apex-custom-radar-chart.js"></script>

        <!-- ChartJS -->
        <script src="..\..\public\assets\js\chartjs\chartjs.min.js"></script>
        ...
        <!-- jvectormap Min JS -->
        <script src="..\..\public\assets\js\jvectormap-1.2.2.min.js"></script>
        <!-- jvectormap World Mil JS -->
        <script src="..\..\public\assets\js\jvectormap-world-mill-en.js"></script>
        <!-- Custom JS -->
